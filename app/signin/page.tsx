...
export default function SignIn() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background">
      ...
      {/* Logo */}
      <Link href="/" className="absolute left-8 top-8 flex items-center space-x-3">
          ...
          <div className="space-y-4">
            <Button
              className={cn(
                ...
                loading ? "cursor-not-allowed opacity-80" : "hover:shadow-primary/20"
              )}
              variant="outline"
              size="lg"
              type="button"
              onClick={() => !loading && handleSignIn("github")}
              disabled={loading}
            >
