...
export default function GradientHero() {
  return (
    <div id="home" className="relative w-full overflow-hidden bg-background">
      {/* Background gradient */}
      ...
      <div className="container relative z-10 mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          >
            An intelligent AI code agent that helps you write better code
            faster. Get smart suggestions, refactoring tips, and code reviews in
            real-time while maintaining complete control over your development
            process.
          </motion.p>
